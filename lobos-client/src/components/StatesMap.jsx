import { MapContainer, useMap, TileLayer, Pane, GeoJSON, Popup } from "react-leaflet";
...
const StatesMap = ( { selectedArea, setSelectedArea, mapView, isOpen }) => {
  ...
  return (
    <>
    <MapContainer center={[36,-92]} zoom={5} style={{ width: '100%', zIndex: 1}} maxBounds={usaBounds} maxBoundsViscosity={0.5} minZoom={5}>
    <MapController selectedArea={selectedArea} mapView={mapView}/>
      ...
      <GeoJSON  key={JSON.stringify(geoJSONLayer)} data={geoJSONLayer} onEachFeature={onEachFeature} zIndex={10}/>
